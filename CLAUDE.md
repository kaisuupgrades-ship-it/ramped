...
- **CSS variables — Brand v3 (dark mode, 2026-05-01).** Migrating from cream/blue (v2) to dark navy + blue/orange accent system per Claude Design prototype. Canonical v3 tokens: `--bg-0:#07090d; --bg-1:#0b0f17; --bg-2:#11161f; --bg-3:#161c27; --bg-4:#1c2331; --line:#1f2735; --line-2:#2a3344; --text-0:#f4f6fa; --text-1:#c5cdd9; --text-2:#8b94a3; --text-3:#5a6373; --blue:#3b82f6; --blue-2:#60a5fa; --blue-glow:rgba(59,130,246,0.35); --orange:#fb923c; --orange-2:#fdba74; --orange-glow:rgba(251,146,60,0.3); --green:#34d399; --red:#f87171; --purple:#a78bfa;`. Border radii: `--radius-sm:8px; --radius:12px; --radius-lg:16px; --radius-xl:24px;`. Pages still on v2 (cream/blue) tokens are mid-migration — track in `BRAND-V3-MIGRATION.md`.
- **Primary CTA color is `--orange` (#fb923c)** on dark backgrounds. Royal blue `--blue` is for emphasis, links, and gradient text. Warning/amber for guarantee badges has been re-tuned to a yellow-gold (different from orange) to avoid semantic confusion.
- **Hero H1 treatment:** the second clause gets a gradient — `background: linear-gradient(120deg, var(--blue-2) 0%, var(--orange) 90%); -webkit-background-clip: text; color: transparent;`. Do not gradient-paint full sentences — only the differentiating clause.
- **Inter weights:** load `400;500;600;700;800` on every page. **JetBrains Mono `400;500;600`** (v3 added 600 weight for stat numbers and timeline week labels). No other variants without a reason.
- **`font-feature-settings: "ss01", "cv11"`** is set on `body` for tighter digit forms — applies site-wide.
